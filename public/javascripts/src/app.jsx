  ...
  render: function() {
    return (
      <div className="container">
        ...
        <SearchForm keyword={this.state.keyword} count={this.state.showing_items_count} is_searching={this.state.is_searching} onChange={this.searchItems}/>
    ...
    return (
      <div className="search-form">
        <Badge badgeContent={this.props.count} primary={primary} secondary={secondary} badgeStyle={{top:36, right:-30, width:40}}>
          <TextField ref="searchForm" value={this.props.keyword} hintText="Keyword" onChange={this._onChange} />
        </Badge>
      </div>
    );
  }
